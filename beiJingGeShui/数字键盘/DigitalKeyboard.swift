...
open class  DigitalKeyboard: UIInputView, UITextFieldDelegate {
    ...
    open var style = KeyStyle.idcard {
        didSet {
    ...
    func setDigitButton(style: KeyStyle) {
...
func addIDKey(textfiled:UITextField,contentView:UIView,vc:UIViewController,selector:Selector)
{
    let keyboard = DigitalKeyboard(view: contentView, field: textfiled)
    keyboard.style = .idcard
    keyboard.backgroundColor = UIColor(red: 255.0/255.0, green: 80.0/255.0, blue: 80.0/255.0, alpha: 1)
    keyboard.customDoneButton(title: "完成", titleColor: .white, theme: UIColor(red: 255.0/255.0, green: 80.0/255.0, blue: 80.0/255.0, alpha: 1) , target: vc, callback: selector)
    keyboard.isSafety = false
    textfiled.inputView = keyboard
}


func addNuberKey(textfiled:UITextField,contentView:UIView)
{
    let keyboard = DigitalKeyboard(view: contentView)
